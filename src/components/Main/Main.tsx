    ...
    return (
        <div className='flex flex-row items-center justify-center gap-[200px] p-[32px] bg-[#fff1e0] max-lg:flex-col-reverse max-lg:gap-[50px]'>
            <div className='flex flex-col items-start gap-[24px] max-lg:w-full'>
                ...
                <a className='bg-[#694b1a] py-[16px] px-[48px] text-[16px] text-white max-lg:px-[24px] hover:bg-white hover:text-[#694b1a] transition'
                onClick={()=> (document.getElementById
                ('my_modal_5') as HTMLDialogElement).showModal() }>{t('mainButton')}</a>
            </div>
            <img
